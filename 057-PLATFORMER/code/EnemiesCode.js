...
class Enemy{
  constructor(p5, centreX, centreY, indexEnemy, directionX) {
    ...
    this.lineString = p5.translate(this.centredLineString, this.centre[0], this.centre[1])
  }
}
...
export class AllEnemies{
  ...
  restart() {
    this.enemies = enemies.map(enemy => new Enemy(this.p5, enemy[2], enemy[3], enemy[0], enemy[1]))
  }
}
...
new p5(p5 => {
  ...
  p5.preload = () => {
    allPlatforms.platformActors.forEach(platform => platform.image = p5.loadImage(`./images/${platform.name}.png`))
  }
  ...
  p5.draw = () => {
    p5.background(backgroundColour.getBackgroundColour(screenPosition, maxScreenPosition));
    allPlatforms.draw()
  }

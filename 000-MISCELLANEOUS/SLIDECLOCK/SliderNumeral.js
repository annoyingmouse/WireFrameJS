export class SliderNumeral {
  ...
  update(num) {
    ...
    if (!this.secondColumnOffset !== positions[num][1] * this.unitHeight) {
      if (this.secondColumnOffset < positions[num][1] * this.unitHeight) {
        this.secondColumnOffset = this.instant
          ? Math.abs(
              this.secondColumnOffset - positions[num][1] * this.unitHeight,
            ) < 5
    ...
    if (!this.thirdColumnOffset !== positions[num][2] * this.unitHeight) {
      if (this.thirdColumnOffset < positions[num][2] * this.unitHeight) {
        this.thirdColumnOffset = this.instant
          ? Math.abs(
              this.thirdColumnOffset - positions[num][2] * this.unitHeight,
            ) < 5

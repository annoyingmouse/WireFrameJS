							...
							function r() {
								function t(t) {
										...
										c.container
											? p.isWrapped(c.container) || p.isNode(c.container)
												? ((c.container = c.container[0] || c.container),
													(M =
														(x = c.container["scroll" + P]) +
														u(r).position()[P.toLowerCase()] +
														A))
												: (c.container = null)
											: ((x =
													v.State.scrollAnchor[v.State["scrollProperty" + P]]),
												(k =
													v.State.scrollAnchor[
														v.State[
															"scrollProperty" + ("Left" === P ? "Top" : "Left")
														]
													]),
												(M = u(r).offset()[P.toLowerCase()] + A)),
											(d = {
												scroll: {
													rootPropertyValue: !1,
													startValue: x,
									...
									d.element &&
										...
										(a(r).isAnimating = !0),
										S === C - 1
											? (v.State.calls.push([$, g, c, null, I.resolver]),
												!1 === v.State.isTicking &&
									...
									if (i.display) {
										...
										if (
											...
											if (m)
												...
												(D = F ? e.left + $ + S.top : e.right - $ - S.top),
			...
			var s,
				...
				Zt = {
					...
					updateSize: function (e) {
						...
						(v = g = a.currItem.initialZoomLevel),
							(J = a.currItem.bounds) &&
								((ut.x = J.center.x), (ut.y = J.center.y), Pt(!0)),
							St("resize");
					},
						...
						if (0 !== t)
							if (
								...
								if (
									...
									return;
								Et(Gt, Z[1]), q || ((q = !0), St("zoomGestureStarted"));
								var e = he(Kt, Gt),
									i = Ee(e);
								i >
				...
				publicMethods: {
					...
					setContent: function (t, e) {
						...
						if (l) {
							...
							Re || e !== u ? At(l) : ((tt = c.style), ze(l, n || l.img)),
								(t.el.innerHTML = ""),
								t.el.appendChild(c);
						} else t.el.innerHTML = "";
					},
								...
								return (
									r.modal &&
										(!r.closeOnScroll || Yt || B
											? t.preventDefault()
											: P && Math.abs(t.deltaY) > 2 && ((c = !0), a.close())),
									!0
								);
